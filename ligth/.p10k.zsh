# Generated by Powerlevel10k configuration wizard on 2023-07-09 at 20:31 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=#aaa
  ...
  #
    ...
    typeset -g POWERLEVEL9K_DIR_HOME_ANCHOR_FOREGROUND=#000
    typeset -g POWERLEVEL9K_DIR_HOME_SHORTENED_FOREGROUND=#aaa
  #
    typeset -g POWERLEVEL9K_DIR_HTB_FOREGROUND=#9FEF00
    typeset -g POWERLEVEL9K_DIR_HTB_ANCHOR_FOREGROUND=#000
    typeset -g POWERLEVEL9K_DIR_HTB_SHORTENED_FOREGROUND=#aaa
  #
    typeset -g POWERLEVEL9K_DIR_DEFAULT_NOT_WRITABLE_FOREGROUND=#ff6060
    typeset -g POWERLEVEL9K_DIR_DEFAULT_NOT_WRITABLE_ANCHOR_FOREGROUND=#000
    typeset -g POWERLEVEL9K_DIR_DEFAULT_NOT_WRITABLE_SHORTENED_FOREGROUND=#aaa
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_VISUAL_IDENTIFIER_EXPANSION='󰃤'
  ...
  #
  # Available sources: - shell   `asdf current` says "set by ASDF_${TOOL}_VERSION environment variable" - local   `asdf current` says "set by /some/not/home/directory/file" - global  `asdf current` says "set by /home/username/file" Note: If this parameter is set to (shell local global), it won't hide tools. Tip:  Override this parameter for ${TOOL} with POWERLEVEL9K_ASDF_${TOOL}_SOURCES. typeset -g POWERLEVEL9K_ASDF_SOURCES=(shell local global) If set to false, hide tool versions that are the same as global. Note: The name of this parameter doesn't reflect its meaning at all.
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%B%n%F{69}㉿%b%m'
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%n%F{69}%B㉿%b%m'
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n%F{69}%B㉿%b%m'
